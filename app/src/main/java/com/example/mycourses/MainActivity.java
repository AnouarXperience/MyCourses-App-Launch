...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* bottomSheetRL = findViewById(R.id.idBSD); */
    ...
    private void displayBottomSheet(CourseRVModal courseRVModal){
        ...
        ImageView courseIV = layout.findViewById(R.id.idTVCourse);
        ...
        courseSuitedForTV.setText("Suited for " + courseRVModal.getBestSuitedFor());
        coursePriceTV.setText(courseRVModal.getCoursePrice()+"DT");
